<style type="text/css">
    ...
    .title_b_invoice{
        ...
        font-size: 40px; font-weight: 700; color: #595959;
    }
    table td{
        font-family: "Roboto", sans-serif;
        font-size: 12px; font-weight: 400; color: #595959;
    }
    ...
    .tb_top_header_invoice .tb2 table td{
        font-family: "Roboto", sans-serif;
        font-size: 12px; font-weight: 400; color: #605863;
    ...
    .tb_top_header_invoice .tb2 table td.sb_header{
         font-family: "Roboto", sans-serif;
        font-size: 12px; font-weight: 400; color: #abb0ac;
    }
</style>
...
<table border="0" cellspacing="0" cellpadding="4" style="width:660px;">
    ...
    .box_bottom_descriptt .tops_bottom_middle table td{
        font-size: 15px; font-weight: 400; color: #5c5959;
    ...
    .box_bottom_descriptt .tops_bottom_middle table td span{
        font-family: "Roboto", sans-serif;
        font-size: 14px; color: #a7b3d1; font-weight: 400;
    }

    ...
    <div class="prelatife container">
		...
		<div class="inside-content">
			...
			<div class="m-ins-content detail-shopcart content-text">
				...
				<p>Thank you for placing your order with DV Computers! <br>
				...
				<p>
				<p>
					<b>Please make payments to:</b> <br>
				    ...
				    <table class="table table-hover shopcart">
				    	...
				    	<tbody>
				    		...
				    		<tr>
				    			...
				    			<td>
				    				<span class="title">
				    					<?php echo $value['name'] ?> @<?php echo Cart::money($value['price']) ?> <br>
				    					<?php if ($value['attributes_name'] != ''): ?>
				    						Product Variations: <?php echo $value['attributes_name'] ?>
				    					<?php endif ?>
				    					<?php /*
				    					<?php if ($value['color'] != ''): ?>

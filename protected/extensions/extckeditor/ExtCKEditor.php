...
//advanced - пользователь сам определяет тулбар
    ...
    public function run(){
        ...
        $source = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'source');
        
        $this->options['filebrowserImageBrowseUrl']=  $source.'/kcfinder/browse.php?type=images&cms=yii';
        $this->options['filebrowserImageBrowseLinkUrl']=$source.'/kcfinder/browse.php?type=images&cms=yii';
        $this->options['filebrowserImageUploadUrl']=$source.'/kcfinder/upload.php?type=images&cms=yii';
        $this->options['filebrowserBrowseUrl'] = $source.'/kcfinder/browse.php?type=files';
        $this->options['filebrowserFlashBrowseUrl'] = $source.'/kcfinder/browse.php?type=flash';
        $this->options['filebrowserUploadUrl'] = $source.'/kcfinder/upload.php?type=files';
        $this->options['filebrowserFlashUploadUrl'] = $source.'/kcfinder/upload.php?type=flash';
        $session = new CHttpSession;
        $session->open();
        // echo Yii::app()->basePath.'/../upload/';
        // exit;

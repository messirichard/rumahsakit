...
$this->menu=array(
	array('label'=>'List <?php echo $this->modelClass; ?>','url'=>array('index', $this->varGet=>$_GET[$this->varGet])),
	array('label'=>'Add <?php echo $this->modelClass; ?>','url'=>array('create', $this->varGet=>$_GET[$this->varGet])),
);
<?php /*

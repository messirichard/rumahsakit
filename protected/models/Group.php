...
class Group extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('akses',$this->akses,true);
	...
	public function getAksesGroup($blob = '')
	{
		$blob = unserialize($blob);
		$data = array();
		if (count($blob) > 0 AND $blob != '') {

	...
	<div class="span12">
		...
		<div class="widgetcontent">
			...
			<div class="divider5"></div>
				...
				<div class="row-fluid">
					<div class="span12">
					<?php $type = 'application_hero_title'; ?>
				...
				<div class="row-fluid hide hidden">
					<div class="span12">
						<?php $type = 'application_hero_subtitle'; ?>
				...
				<div class="divider5"></div>
				<?php $type = 'application_hero_background'; ?>
		...
		<h4 class="widgettitle">Section 1</h4>
			<div class="widgetcontent">
					<div class="row-fluid">
						<div class="span12">
							<?php $type = 'application_section1_subtitle'; ?>
		...
		<div class="widget">
			...
			<div class="widgetcontent">
				<?php $type = 'application_meta_title'; ?>
				...
				<?php endforeach ?>	
				<div class="divider5"></div>
				<?php $type = 'application_meta_keyword'; ?>
				...
				<?php endforeach ?>	
				<div class="divider5"></div>
				<?php $type = 'application_meta_description'; ?>

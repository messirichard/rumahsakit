                            ...
                            <td width="50%">
                                ...
                                <?php 
                                 ...
                                 ?><br>
                                    ...
                                    <br>
                                    <b class="red"><?php echo strtoupper($value->delivery_package) ?></b>
                                 </p>
                                <div class="clear height-10"></div>                                
                                <h5>DARI: <?php echo nl2br($alamat_kantor) ?></h5> 
                                <p>
                                <small style="font-size: 10px;"><?php echo $strs_name_prd ?></small>
                                <div style="clear:both; height:0px;"></div>
                                <small style="font-size: 11px;">(<?php echo $qtys ?> Box)</small>
                                </p>
                            </td>
                            <?php endforeach ?>
                        </tr>

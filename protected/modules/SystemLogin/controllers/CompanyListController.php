...
class CompanyListController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MemberCompany']))
		{
			...
			if($model->validate()){
				...
				{
					if ($image->name != '') {
						$image->saveAs(Yii::getPathOfAlias('webroot').'/images/company/'.$model->image);
					}
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('MemberCompany');
